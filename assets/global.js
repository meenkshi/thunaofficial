...
class SlideshowComponent extends SliderComponent {
  ...
  update() {
    ...
    this.prevButton.removeAttribute('enable');
...
class VariantSelects extends HTMLElement {
  ...
  onVariantChange() {
    ...
    setTimeout(function (){
    var tt = document.getElementById("submit-button");
      var text = tt.innerHTML;
    
    if(text == "Sold out")
    {
          document.getElementById("in_stock").innerHTML =
            '<span class="out_of_stock" id="change_of_stock">Out Of Stock</span>';
    }else{
       document.getElementById("in_stock").innerHTML =
            '<span id="change_stock">In Stock</span>';
    }
  }, 2000);
    this.updateOptions();
    this.updateMasterId();
